            ...
            <div className="relative flex flex-col lg:flex-row">
                ...
                <div className="relative z-10 flex flex-col p-5 m-5 w-full border-2 bg-whitebg border-b-[20px] border-b-800 rounded-bl-3xl rounded-br-3xl rounded-3xl min-w-[700px]">
                    ...
                    <article className="w-full h-full rounded-3xl flex flex-col justify-center">
                        ...
                        <img src={singapore1qr} className="w-[160px] my-5"/>
                    </article>
                    ...
                    <article className="w-full h-full rounded-3xl flex flex-col justify-center">
                        ...
                        <img src={singapore2qr} className="w-[160px] my-5"/>
                    </article>
                    </div>
                </div>
                ...
                <div className="relative z-10 flex flex-col p-5 m-5 w-full border-2 bg-whitebg border-b-[20px] border-b-800 rounded-bl-3xl rounded-br-3xl rounded-3xl min-w-[700px]">
                    ...
                    <div className="flex gap-5">
                        ...
                        <article className="w-full rounded-3xl flex flex-col">
                            ...
                            <img src={indiaqr} className="w-[160px] my-5"/>
                        </article>
                        </div>
                    ...
                    {/* Indonesia Section */}
                        ...
                        <article className="w-full rounded-3xl flex flex-col justify-end">
                            ...
                            <img src={indonesiaqr} className="w-[160px] my-5"/>
                        </article>
                        </div>
                    </div>
                </div>
